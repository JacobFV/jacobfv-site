...
<div className="row justify-content-sm-center">
    ...
    <div className="col-sm-4 mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="example image"/>
    </div>
</div>
...
<div className="row">
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="CookieCutter mechanotronics"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="CookieCutter electronics"/>
    </div>
    <div className="col-sm mt-3 mt-md-0">
        <img className="img-fluid rounded z-depth-1" src="" alt="" title="CookieCutter mechanotronics"/>
    </div>
...
<div className="row">
    <img className="img-fluid rounded z-depth-1" src="" alt="" title="Final CookieCutter"/>
    <div className="col-sm mt-3 mt-md-0">
    ...
    <img className="img-fluid rounded z-depth-1" src="" alt="" title="Cookie Control"/>
</div>
